...
| 1 | `https://yuchienpsy.com/articles/self-care-07.html` | quota-blocked | 2026-06-20 | First retry target. Prior Search Console result: discovered, not indexed; Request indexing failed due quota. |
