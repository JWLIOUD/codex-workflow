...
| 1 | `https://yuchienpsy.com/articles/self-care-07.html` | quota-blocked | 2026-06-22 | First retry target. Prior Search Console result: discovered, not indexed; Request indexing failed due quota. 2026-06-22 automation could not inspect because browser policy blocked Search Console access; no indexing request made. |
